...
class Process {
    ...
    // Checks that this process no longer has any more CPU or blocking time is no longer needed
    isFinished() {
    ...
    // If `this.blockingTimeNeeded` is 0 or less, emit a queue interrupt nofifying (process and interupt string)
